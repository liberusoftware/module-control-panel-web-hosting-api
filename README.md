...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-control-panel-web-hosting-api?sort=semver)](https://github.com/liberusoftware/module-control-panel-web-hosting-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-control-panel-web-hosting-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-control-panel-web-hosting-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-control-panel-web-hosting-api
```
...
<a href="https://github.com/liberusoftware/module-control-panel-web-hosting-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-control-panel-web-hosting-api" alt="Contributors to liberusoftware/module-control-panel-web-hosting-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-control-panel-web-hosting-api/graphs/contributors).
